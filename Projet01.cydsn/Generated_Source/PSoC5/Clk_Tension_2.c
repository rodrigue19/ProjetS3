...
/*******************************************************************************
* Function Name: Clk_Tension_2_Start
********************************************************************************
*
* Summary:
...
void Clk_Tension_2_Start(void) 
{
    ...
    Clk_Tension_2_CLKEN |= Clk_Tension_2_CLKEN_MASK;
	Clk_Tension_2_CLKSTBY |= Clk_Tension_2_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clk_Tension_2_Stop
********************************************************************************
*
* Summary:
...
void Clk_Tension_2_Stop(void) 
{
    ...
    Clk_Tension_2_CLKEN &= (uint8)(~Clk_Tension_2_CLKEN_MASK);
	Clk_Tension_2_CLKSTBY &= (uint8)(~Clk_Tension_2_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clk_Tension_2_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Clk_Tension_2_CLKEN & Clk_Tension_2_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Clk_Tension_2_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clk_Tension_2_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clk_Tension_2__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clk_Tension_2_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clk_Tension_2_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clk_Tension_2_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Clk_Tension_2_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Clk_Tension_2_GetSourceRegister();
    uint16 oldDivider = Clk_Tension_2_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clk_Tension_2_CLKEN & Clk_Tension_2_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(Clk_Tension_2_DIV_PTR, clkDivider);
                Clk_Tension_2_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                Clk_Tension_2_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(Clk_Tension_2_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clk_Tension_2_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clk_Tension_2_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Clk_Tension_2_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clk_Tension_2_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Clk_Tension_2_MOD_SRC |= modeBitMask & (uint8)Clk_Tension_2_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clk_Tension_2_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Clk_Tension_2_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clk_Tension_2_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clk_Tension_2_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Clk_Tension_2_MOD_SRC & (uint8)(Clk_Tension_2_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clk_Tension_2_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Clk_Tension_2_GetDividerRegister();
    uint8 oldSrc = Clk_Tension_2_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clk_Tension_2_MOD_SRC |= CYCLK_SSS;
        Clk_Tension_2_MOD_SRC =
            (Clk_Tension_2_MOD_SRC & (uint8)(~Clk_Tension_2_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clk_Tension_2_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Clk_Tension_2_MOD_SRC & Clk_Tension_2_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clk_Tension_2_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Clk_Tension_2_PHASE = clkPhase & Clk_Tension_2_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clk_Tension_2_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Clk_Tension_2_PHASE & Clk_Tension_2_PHASE_MASK;
}
