...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800015Cu)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000164u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800016Cu)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000174u)

/* IOPINS0_2 Address: CYREG_PRT2_DR Size (bytes): 10 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x4800017Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x03E7u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x26u);
...
static uint8 CYXDATA * const CYCODE AMux_1__outerAddr[4] = {
	(uint8 CYXDATA *)CYREG_DAC3_SW0, 
	(uint8 CYXDATA *)CYREG_DAC0_SW0, 
	(uint8 CYXDATA *)CYREG_DAC1_SW0, 
	(uint8 CYXDATA *)CYREG_DAC2_SW0, 
};

static const uint8 CYCODE AMux_1__outerMask[4] = {
	0x20u, 
	0x02u, 
	0x02u, 
	0x20u, 
...
static uint8 CYXDATA * const CYCODE AMux_1__innerAddr[1] = {
	(uint8 CYXDATA *)CYREG_PRT1_AG, 
};

static const uint8 CYCODE AMux_1__innerMask[1] = {
	0x40u, 
};

static const uint8 CYCODE AMux_1__innerMap[4] = {
	0u, 
	0u, 
	0u, 
	0u, 
...
static uint8 AMux_1__refCnt[] = {0u};
...
void AMux_1_Set(uint8 channel)
{
	...
	if ((channel < 4u) && ((AMux_1__armsEnabled & channelMask) == ((uint32)0u)))
	{
...
static uint8 CYXDATA * const CYCODE AMux_2__outerAddr[16] = {
...
static const uint8 CYCODE AMux_2__outerMask[16] = {
	0x01u, 
	0x02u, 
	0x08u, 
	0x10u, 
...
static uint8 CYXDATA * const CYCODE AMux_2__innerAddr[1] = {
	(uint8 CYXDATA *)CYREG_PRT1_AMUX, 
};

static const uint8 CYCODE AMux_2__innerMask[1] = {
	0x80u, 
};

static const uint8 CYCODE AMux_2__innerMap[16] = {
	0u, 
	0u, 
	0u, 
	0u, 
...
static uint16 AMux_2__armsEnabled = 0u;
static uint8 AMux_2__refCnt[] = {0u};
...
{
	uint8 i;
	uint16 channelMask = (1UL << channel);
	if ((channel < 16u) && ((AMux_2__armsEnabled & channelMask) == ((uint32)0u)))
	{
		AMux_2__armsEnabled |= channelMask;
		*AMux_2__outerAddr[channel] |= AMux_2__outerMask[channel];
		i = AMux_2__innerMap[channel];
		if (AMux_2__refCnt[i] == 0u)
		{
			*AMux_2__innerAddr[i] |= AMux_2__innerMask[i];
		}
		AMux_2__refCnt[i]++;
	}
}
...
void AMux_2_Unset(uint8 channel)
{
	...
	if ((channel < 16u) && ((AMux_2__armsEnabled & channelMask) != ((uint32)0u)))
	{
		AMux_2__armsEnabled &= (uint16)~channelMask;
		*AMux_2__outerAddr[channel] &= (uint8)~AMux_2__outerMask[channel];
		i = AMux_2__innerMap[channel];
		AMux_2__refCnt[i]--;
		if (AMux_2__refCnt[i] == 0)
		{
			*AMux_2__innerAddr[i] &= (uint8)~AMux_2__innerMask[i];
		}
	}
}
